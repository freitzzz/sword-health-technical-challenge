...
func TestOnlyAllowTechnicianAccessMiddlewareReturnsInternalServerErrorIfUserContextIsNotPresent(t *testing.T) {
	e := echo.New()

	e.Use(onlyAllowTechnicianMiddleware())
...
func TestOnlyAllowTechnicianAccessMiddlewareReturnsUnauthorizedIfIsTechnicianCallReturnsFalse(t *testing.T) {
	e := echo.New()
...
func TestOnlyAllowTechnicianAccessMiddlewareProceedsMiddlewareIfIsTechnicianCallReturnsTrue(t *testing.T) {
	e := echo.New()
...
func TestResourceIdentifierValidationMiddlewareProceedsMiddlewareIfNoTaskResourceIdentifierExistsInPathParameters(t *testing.T) {
	e := echo.New()
...
func TestResourceIdentifierValidationMiddlewareReturnsNotFoundIfTaskResourceIdentifierExistsInPathParametersButIsEmpty(t *testing.T) {
	e := echo.New()

	e.GET(fmt.Sprintf("/:%s", taskId), func(c echo.Context) error {
...
func TestResourceIdentifierValidationMiddlewareReturnsNotFoundIfTaskResourceIdentifierExistsInPathParametersButItsValueIsNegative(t *testing.T) {
	e := echo.New()
